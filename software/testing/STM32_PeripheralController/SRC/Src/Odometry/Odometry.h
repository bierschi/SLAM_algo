...
typedef float OdometryAngularType;  // type for odometry angular measurements
...
extern OdometryAngularType ODO_GetCurrentOrientationXR(void);
extern OdometryAngularType ODO_GetCurrentOrientationYR(void);
extern OdometryAngularType ODO_GetCurrentOrientationZR(void);
