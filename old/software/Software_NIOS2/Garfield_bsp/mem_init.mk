...
MEM_0 := Garfield_system_epcs_flash_controller_0_boot_rom
...
$(MEM_0)_START := 0x000a0000
$(MEM_0)_END := 0x000a07ff
...
# Memory: onchip_memory2_nios2
MEM_1 := Garfield_system_onchip_memory2_nios2
$(MEM_1)_NAME := onchip_memory2_nios2
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_memory2_nios2
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memory2_nios2
onchip_memory2_nios2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: shared_memory_master_hps_0
MEM_2 := Garfield_system_shared_memory_master_hps_0
$(MEM_2)_NAME := shared_memory_master_hps_0
...
$(MEM_2)_START := 0x00060000
$(MEM_2)_END := 0x000607ff
$(MEM_2)_SPAN := 0x00000800
$(MEM_2)_HIERARCHICAL_PATH := shared_memory_master_hps_0
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: shared_memory_master_hps_0
shared_memory_master_hps_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: shared_memory_master_nios_0
MEM_3 := Garfield_system_shared_memory_master_nios_0
$(MEM_3)_NAME := shared_memory_master_nios_0
...
$(MEM_3)_START := 0x00090000
$(MEM_3)_END := 0x000907ff
$(MEM_3)_SPAN := 0x00000800
$(MEM_3)_HIERARCHICAL_PATH := shared_memory_master_nios_0
$(MEM_3)_WIDTH := 32
$(MEM_3)_HEX_DATA_WIDTH := 32
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: shared_memory_master_nios_0
shared_memory_master_nios_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
