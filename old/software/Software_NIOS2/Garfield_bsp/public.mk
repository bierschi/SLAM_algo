...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Garfield_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Garfield_system
SOPC_NAME := Garfield_system
...
# The SOPC System ID 
# setting SOPC_SYSID is 17047575
SOPC_SYSID_FLAG += --id=17047575
ELF_PATCH_FLAG  += --id 17047575

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x10000
SOPC_SYSID_FLAG += --sidp=0x10000
ELF_PATCH_FLAG  += --sidp 0x10000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1496839578
SOPC_SYSID_FLAG += --timestamp=1496839578
ELF_PATCH_FLAG  += --timestamp 1496839578
...
# setting hal.stderr is jtag_uart_nios2
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_nios2

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_nios2
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_nios2
...
# setting hal.stdout is jtag_uart_nios2
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_nios2
